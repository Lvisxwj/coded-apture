...
class ATTU(nn.Module):
    def __init__(self, bilinear=False):
        super(ATTU, self).__init__()
        ...
        self.MSABC0 = MSABC(dim=64)
        self.MSABC1 = MSABC(dim=128)
        self.MSABC2 = MSABC(dim=256)
        self.MSABC3 = MSABC(dim=512)
        self.MSABC4 = MSABC(dim=1024)
        self.MSABC5 = MSABC(dim=512)
        self.MSABC6 = MSABC(dim=256)
        self.MSABC7 = MSABC(dim=128)
        self.MSABC8 = MSABC(dim=64)
